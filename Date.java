 ...
 */
public abstract class Date implements Reportable
{
    ...
    public void setYear(int year) throws InvalidDateException
    {
        if(!(MIN_YEAR > year || MAX_YEAR < year)){
            ...
            throw new InvalidDateException(year + " is not a valid year");
        }
    }
    ...
    {
        if(!(JANUARY > month || DECEMBER < month)){
            this.month = month;
        }else{
            throw new InvalidDateException(month + " is not a valid month");
        }
    } // end mutator
    ...
    {
        if(!(MIN_DAY > day || getNumberOfDaysInThisMonth() < day)){
            this.day = day;
        }else{
            throw new InvalidDateException(day + " is not a valid day");
        }
    }// end mutator
